...
class VinuSwapStateNotifier extends StateNotifier<VinuSwapState> {
  final VinuSwapService service;

  VinuSwapStateNotifier({
    required this.service,
    required VinuSwapState state,
  }) : super(state);
  ...
  Future<void> _fetchFromAmount({
    ...
    try {
      ...
      final fromAmount = await service.getOppositeQuote(
  ...
  Future<void> _fetchToAmount({
    ...
    try {
      state = state.copyWith(requestId: requestId);
      final toAmount = await service.getQuote(
