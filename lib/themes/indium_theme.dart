...
class IndiumTheme extends BaseTheme {
  ...
  Color primary60 = deepBlue.withValues(alpha: 0.6);
  Color primary45 = deepBlue.withValues(alpha: 0.45);
  Color primary30 = deepBlue.withValues(alpha: 0.3);
  Color primary20 = deepBlue.withValues(alpha: 0.2);
  Color primary15 = deepBlue.withValues(alpha: 0.15);
  Color primary10 = deepBlue.withValues(alpha: 0.1);
