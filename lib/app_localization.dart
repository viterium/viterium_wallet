...
class AppLocalization {
  ...
  String get powSettings {
    return Intl.message('PoW Settings',
        desc: 'pow_settings', name: 'powSettings');
  }
  ...
  String get welcomeText {
    return Intl.message(
        "Welcome to Viterium. To begin, you may create a new wallet or import an existing one.",
  ...
  String get enterMemo {
    return Intl.message("Enter Memo", desc: 'enter_memo', name: 'enterMemo');
  }
  ...
  String get changeSbpAuthenticate {
    return Intl.message("Vote for SBP",
        desc: 'settings_change_rep', name: 'changeRepAuthenticate');
  }

  String get currentlyVotingFor {
    return Intl.message("Currently Voting For",
        desc: 'change_representative_current_header',
        name: 'currentlyRepresented');
  }

  String get changeSbpVoteSuccess {
    return Intl.message("SBP Vote Successful",
        desc: 'change_representative_success', name: 'changeRepSucces');
  }

  String get sbpInfoHeader {
    return Intl.message("What is a SBP?",
        desc: 'change_representative_info_header', name: 'repInfoHeader');
  }

  String get sbpInfo {
    return Intl.message(
        "A SBP (Snapshot Block Producer) is responsible for producing snapshot blocks and securing consensus on the Vite chain. Each round of voting lasts 75 seconds. For each round, 23 of the top 25 candidates plus 2 candidates ranking 26th to 100th, 25 nodes in total, will be elected as SBPs.",
        desc: 'change_sbp_info',
        name: 'sbpInfo');
  }

  String get sbpInfoContinued {
    return Intl.message(
        "Your vote is proportional to the VITE balance of your account. In next rounds, you will automatically keep voting for the selected node until you revoke your vote or vote for another candidate node.",
        desc: 'change_sbp_info_continued',
        name: 'sbpInfoContinued');
  }

  String get pinChangeSbpVote {
    return Intl.message("Enter PIN to Change SBP Vote.",
        desc: 'change_sbp_vote_pin', name: 'pinSbpVoteChange');
  }

  String get candidateNodes {
    return Intl.message("SBP Candidate Nodes",
        desc: 'candidate_nodes', name: 'candidateNodes');
  }

  String get changeVote {
    return Intl.message("Change Vote",
        desc: 'change SBP vote', name: 'changeVote');
  }

  String get revokeVoteHeader {
    return Intl.message("Revoke Vote?",
        desc: 'revoke SBP vote header', name: 'revokeVoteHeader');
  }

  String get revokeVoteText {
    return Intl.message("Are you sure you want to revoke your vote?",
        desc: 'revoke SBP vote text', name: 'revokeVoteText');
  }

  String get revokeVote {
    return Intl.message("Revoke Vote",
        desc: 'revoke SBP vote', name: 'revokeVote');
  }

  String get revoke {
    return Intl.message("Revoke", desc: 'revoke SBP vote', name: 'revoke');
  }

  String get revokeMessage {
    return Intl.message("SBP vote revoked",
        desc: 'SBP vote revoked', name: 'sbpRevokedMessage');
  }

  String get blockProducingAddress => Intl.message('Address',
      desc: 'SBP block producing address', name: 'blockProducingAddress');

  String get sbpVotes {
    return Intl.message('Votes', desc: 'SBP Votes', name: 'sbpVotes');
  }

  String get sbpTotalVotes {
    return Intl.message('Total SBP votes', desc: 'SBP Votes', name: 'sbpVotes');
  }

  String get sbpYourVotes {
    return Intl.message('Your votes', desc: 'SBP Votes', name: 'sbpVotes');
  }
  ...
  String get shareViterium {
    return Intl.message("Share Viterium",
        desc: 'settings_share', name: 'shareViterium');
  }
  ...
  String get shareViteriumSubject {
    return Intl.message(
      "Check out Viterium Wallet",
      desc: 'share_subject',
      name: 'shareViteriumSubject',
    );
  }
  ...
  String get notificationBody {
    return Intl.message("Open Viterium to view this transaction",
  ...
  String get viteriumWallet {
    return Intl.message("Viterium Wallet",
        desc: 'viterium_wallet', name: 'viteriumWallet');
  }
  ...
  String get transferIntro {
    return Intl.message(
        "This process will transfer the funds from a paper wallet to your Viterium wallet.\n\nTap the \"%1\" button to start.",
        desc: 'transfer_intro',
        name: 'transferIntro');
  }
  ...
  String get transferComplete {
    return Intl.message(
        "%1 VITE successfully transferred to your Viterium Wallet.\n",
  ...
  String get unlockPin {
    return Intl.message("Enter PIN to Unlock Wallet",
        desc: 'unlock_viterium_pin', name: 'unlockPin');
  }

  String get unlockBiometrics {
    return Intl.message("Authenticate to Unlock Wallet",
        desc: 'unlock_viterium_bio', name: 'unlockBiometrics');
  }
  ...
  String get exampleCardIntro {
    return Intl.message(
        "This is the transactions tab. Once you send or receive a transaction, it will show up like this:",
  ...
  String get importSecretPhraseHint {
    return Intl.message("Please enter your 12 or 24 word secret phrase below.",
  ...
  String get connectingHeader {
    return Intl.message("Connecting",
        desc:
            'A header to let the user now that Viterium is currently connecting to (or loading) live chat.',
        name: 'connectingHeader');
  }

  String get eulaUrl {
    return 'https://viterium.io/assets/wallet/eula.html';
  }

  String get privacyUrl {
    return 'https://viterium.io/assets/wallet/privacy-policy.html';
  }
