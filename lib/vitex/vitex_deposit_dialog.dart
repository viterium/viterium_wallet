...
class VitexDepositDialog extends HookConsumerWidget {
  final TokenInfo tokenInfo;
  const VitexDepositDialog({super.key, required this.tokenInfo});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tokenBalance = ref.watch(
      formatedTokenBalanceProvider(tokenInfo.tokenId),
    );
    ...
    void onMax() {
      final amount = Amount.raw(balance, tokenInfo: tokenInfo);
      ...
      builder: (context, constraints) {
        return SimpleDialog(
          ...
          title: Padding(
            ...
            child: Text('Stake Amount', style: styles.textStyleDialogHeader),
          ),
          children: [
            Container(
