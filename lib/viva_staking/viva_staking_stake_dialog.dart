...
class VivaStakingStakeDialog extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final tokenBalance = ref.watch(
      formatedTokenBalanceProvider(poolInfo.stakingTokenId),
    );
    ...
    void onMax() {
      ...
      final amount = Amount.raw(maxStake, tokenInfo: poolInfo.stakingTokenInfo);
          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                TextButton(
                  style: styles.dialogButtonStyle,
                  child: Text('STAKE', style: styles.textStyleDialogButtonText),
                  onPressed: onStake,
                ),
              ],
            ),
